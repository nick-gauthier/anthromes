...
region_summary %>% 
 ...
 ggplot(aes(as.factor(year), percent_land_area)) +
  geom_col(aes(fill = class), color = 'white', size = .05)+
  ...
  labs(x = 'Year', y = NULL) +
  theme(legend.position = 'none', strip.text.x = element_text(hjust = 0 ), strip.text.y.left = element_text(angle = 0, hjust = 1), panel.spacing.y=unit(.25, "lines"), strip.background = element_blank(), axis.line.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank())
