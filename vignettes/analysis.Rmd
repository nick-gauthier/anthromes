...
Summary of of global land area for each anthrome.
```{r}
...
contemp_summary <- bind_rows(kba_summary, unused_summary, 
                             nmh3_summary, nmh4_summary, 
                             shared_3gc_summary, wild_3gc_summary) %>%
  # make sure they plot in the right order
  mutate(var = factor(var, levels = c('Key Biodiversity Areas', 'Seminatural and Wildlands (2017)', 
